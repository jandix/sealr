...
## plumber
Plumber is an R package that allows you to quickly generate an API (Application Programming Interface) from 
your R code.

## sealr 
sealr aims to facilitate implementing authentication and authorization for plumber APIs.
...
Those are just two scenarios that come to mind. 


## Using plumber filters for auth
